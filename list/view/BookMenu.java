...
public class BookMenu {
	...
	public void insertBook() {
		...
		System.out.print("도서명을 입력 해 주세요 : ");
		String title = sc.nextLine();
		System.out.print("저자명을 입력 해 주세요 : ");
		String author = sc.nextLine();
		System.out.print("장르를 입력 해 주세요 (1.인문 / 2.자연과학 / 3.의료 / 4.기타) : ");
	...
	public void selectList() {
		...
		if(bookList.isEmpty()) {
			System.out.println("도서목록이 비어 있습니다.");
		}else
	...
	public void searchBook() {
		...
		System.out.print("검색할 도서 키워드를 입력 하십시오 : ");
	...
	public void deleteBook() {
		...
		System.out.print("삭제할 도서명을 입력 하시오 : ");
		String title = sc.nextLine();
		System.out.print("삭제할 저자명을 입력 하시오 : ");
		String author = sc.nextLine();
		...
		if(result == 1) {
			...
			System.out.println("삭제 할 도서를 찾지 못 했습니다.");
		}
